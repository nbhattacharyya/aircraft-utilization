...
export declare namespace Config {
    ...
    function restart(keys: string[]): Promise<{
        ...
        sitesWithPrefetch: (NextjsSiteMetadata | AstroSiteMetadata | RemixSiteMetadata | SolidStartSiteMetadata | SvelteKitSiteMetadata)[];
        functionsWithPrefetch: FunctionMetadata[];
    }>;
}
export {};
